 ...
 * @author daniloues
 */
public class TipoAtributoBeanTest {
    
    EntityManager emGeneradorExcepcion;
    List<TipoAtributo> listaRegistros;
    
    
    
    public TipoAtributoBeanTest() {
            
            
            
//    this.listaRegistros = new ArrayList<>();
//        this.listaRegistros.add(new TipoAtributo(1));
//        this.listaRegistros.get(0).setNombre("chepe");
//        this.listaRegistros.add(new TipoAtributo(2));
//        this.listaRegistros.add(new TipoAtributo(3));
    ...
    public void testCreate() {
        ...
        nuevo.setNombre("Atributo1SoloNumeros");
        nuevo.setNombreScreen("AtributoPantalla");
        nuevo.setExpresionRegular("\\d+");
        nuevo.setIndicacionesScreen("Unicamente numeros");
